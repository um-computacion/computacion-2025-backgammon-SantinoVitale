...
backgammon/cli/CLI.py:379:11: R1714: Consider merging these comparisons with 'in' by using 'position in ('bar', 'barra')'. Use a set instead if elements are hashable. (consider-using-in)
backgammon/cli/CLI.py:381:11: R1714: Consider merging these comparisons with 'in' by using 'position in ('off', 'fuera')'. Use a set instead if elements are hashable. (consider-using-in)
...
backgammon/core/BackgammonGame.py:242:4: R0911: Too many return statements (8/6) (too-many-return-statements)
