...
************* Module backgammon.pygame_ui.highlight_renderer
backgammon/pygame_ui/highlight_renderer.py:35:8: C0103: Attribute name "SELECTED_COLOR" doesn't conform to snake_case naming style (invalid-name)
backgammon/pygame_ui/highlight_renderer.py:36:8: C0103: Attribute name "VALID_MOVE_COLOR" doesn't conform to snake_case naming style (invalid-name)
backgammon/pygame_ui/highlight_renderer.py:37:8: C0103: Attribute name "INVALID_MOVE_COLOR" doesn't conform to snake_case naming style (invalid-name)
backgammon/pygame_ui/highlight_renderer.py:145:61: E1101: Module 'pygame' has no 'SRCALPHA' member (no-member)
backgammon/pygame_ui/highlight_renderer.py:171:67: E1101: Module 'pygame' has no 'SRCALPHA' member (no-member)
backgammon/pygame_ui/highlight_renderer.py:6:0: W0611: Unused Optional imported from typing (unused-import)
...
backgammon/pygame_ui/pygame.py:210:17: W0511: TODO: Execute move in future step (fixme)
...
backgammon/pygame_ui/pygame.py:274:8: E1101: Module 'pygame' has no 'quit' member (no-member)
...
************* Module backgammon.pygame_ui.text_renderer
backgammon/pygame_ui/text_renderer.py:44:4: R0913: Too many arguments (7/5) (too-many-arguments)
backgammon/pygame_ui/text_renderer.py:44:4: R0917: Too many positional arguments (7/5) (too-many-positional-arguments)
backgammon/pygame_ui/text_renderer.py:74:4: R0913: Too many arguments (7/5) (too-many-arguments)
backgammon/pygame_ui/text_renderer.py:74:4: R0917: Too many positional arguments (7/5) (too-many-positional-arguments)
************* Module backgammon.pygame_ui.board_renderer
backgammon/pygame_ui/board_renderer.py:93:0: C0301: Line too long (103/100) (line-too-long)
backgammon/pygame_ui/board_renderer.py:19:0: R0902: Too many instance attributes (9/7) (too-many-instance-attributes)
backgammon/pygame_ui/board_renderer.py:75:4: R0913: Too many arguments (8/5) (too-many-arguments)
backgammon/pygame_ui/board_renderer.py:75:4: R0917: Too many positional arguments (8/5) (too-many-positional-arguments)
backgammon/pygame_ui/board_renderer.py:19:0: R0903: Too few public methods (1/2) (too-few-public-methods)
