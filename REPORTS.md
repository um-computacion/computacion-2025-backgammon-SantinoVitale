...
-----------------------------------------------------------------
backgammon/core/BackgammonGame.py     244     57    77%   54-57, 87-88, 160-165, 168-173, 179, 207-225, 245, 250-254, 258-262, 272, 282, 337-341, 363-370, 466-468, 476-478, 492-493, 538
...
backgammon/cli/CLI.py:430:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:433:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:437:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:441:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:444:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:452:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:457:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:462:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:467:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:469:53: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:472:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:474:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:486:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:505:0: C0303: Trailing whitespace (trailing-whitespace)
backgammon/cli/CLI.py:509:0: C0303: Trailing whitespace (trailing-whitespace)
...
backgammon/cli/CLI.py:476:20: R1724: Unnecessary "elif" after "continue", remove the leading "el" from "elif" (no-else-continue)
backgammon/cli/CLI.py:446:8: R1702: Too many nested blocks (8/5) (too-many-nested-blocks)
backgammon/cli/CLI.py:421:4: R0915: Too many statements (60/50) (too-many-statements)
************* Module backgammon.cli.__init__
backgammon/cli/__init__.py:9:0: C0304: Final newline missing (missing-final-newline)
...
backgammon/core/BackgammonGame.py:227:4: R0911: Too many return statements (8/6) (too-many-return-statements)
backgammon/core/BackgammonGame.py:356:16: R1705: Unnecessary "else" after "return", remove the "else" and de-indent the code inside it (no-else-return)
backgammon/core/BackgammonGame.py:305:4: R0912: Too many branches (18/12) (too-many-branches)
...
backgammon/test/test__BackgammonGame.py:31:8: C0415: Import outside toplevel (backgammon.cli.CLI) (import-outside-toplevel)
backgammon/test/test__BackgammonGame.py:256:8: W0212: Access to a protected member _calculate_move_distance of a client class (protected-access)
