...
from backgammon.cli.backgammon_cli import BackgammonCLI
...
class TestBackgammonCLIDisplayBoard(unittest.TestCase):
    ...
    @patch("backgammon.cli.backgammon_cli.UserInterface.display")
    ...
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_message")
...
class TestBackgammonCLIGetMoveInput(unittest.TestCase):
    ...
    @patch(
        "backgammon.cli.backgammon_cli.UserInterface.get_move_input",
        return_value="12 8",
    )
    ...
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_error")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_message")
...
class TestBackgammonCLIRunGame(unittest.TestCase):
    ...
    @patch(
        "backgammon.cli.backgammon_cli.UserInterface.get_player_name",
    ...
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_message")
    @patch("backgammon.cli.backgammon_cli.UserInterface.clear_screen")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_current_player")
    ...
    @patch("backgammon.cli.backgammon_cli.UserInterface.clear_screen")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_current_player")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_dice_roll")
    ...
    @patch("backgammon.cli.backgammon_cli.UserInterface.clear_screen")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_current_player")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_available_moves")
    def test_run_game_with_successful_move(
        ...
        self.cli.game_controller.has_moves_remaining = Mock(side_effect=[True, False])
    ...
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_current_player")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_available_moves")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_help")
    def test_run_game_with_help_command(
        ...
        self.cli.command_parser.get_command_type = Mock(side_effect=["help", None])
        self.cli.game_controller.make_move = Mock(return_value=True)
    ...
    def test_run_game_with_moves_command(
        ...
        self.cli.command_parser.get_command_type = Mock(side_effect=["moves", None])
    ...
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_current_player")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_available_moves")
    @patch("backgammon.cli.backgammon_cli.UserInterface.display_game_rules")
    def test_run_game_with_rules_command(
        ...
        self.cli.command_parser.get_command_type = Mock(side_effect=["rules", None])
        self.cli.game_controller.make_move = Mock(return_value=True)
        self.cli.game_controller.calculate_move_distance = Mock(return_value=4)
        self.cli.game_controller.use_dice_move = Mock()
        self.cli.game_controller.can_continue_turn = Mock(return_value=False)
    ...
    def test_run_game_with_quit_command_not_confirmed(
        ...
        self.cli.command_parser.get_command_type = Mock(side_effect=["quit", None])
        self.cli.ui.confirm_action = Mock(return_value=False)
        self.cli.game_controller.make_move = Mock(return_value=True)
        self.cli.game_controller.calculate_move_distance = Mock(return_value=4)
        self.cli.game_controller.use_dice_move = Mock()
