...
class BackgammonGame:
    ...
    def is_valid_move(self, from_pos: Union[int, str], to_pos: Union[int, str]) -> bool:
        ...
        return (self.board.is_valid_move(from_pos, to_pos, current_player.color) and
                self.dice.can_use_move(distance))
    ...
    def get_possible_moves(self) -> List[Tuple[Union[int, str], Union[int, str]]]:
        ...
        """
        current_player = self.get_current_player()
        return self.board.get_possible_moves(current_player.color, self.dice.get_moves())
    ...
    def validate_move_coordinates(self, from_pos: Union[int, str], to_pos: Union[int, str]) -> bool:
        """
